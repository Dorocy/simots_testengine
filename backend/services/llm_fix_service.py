...
REPAIR_API_URL = os.getenv(
    "REPAIR_API_URL",
    "https://stranger-carbon-intervals-modes.trycloudflare.com/repair",
).rstrip("/")
REPAIR_TIMEOUT_SECONDS = float(os.getenv("REPAIR_TIMEOUT_SECONDS", "120"))
REVERIFY_BASE_URL = os.getenv(
    "REVERIFY_BASE_URL",
    os.getenv("VERIFICATION_PROXY_URL", "https://stranger-carbon-intervals-modes.trycloudflare.com"),
).rstrip("/")
