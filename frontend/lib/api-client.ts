...
const LLM_REPAIR_API_ENDPOINT =
  process.env.NEXT_PUBLIC_REPAIR_FIX_ENDPOINT ?? "https://code-distribution-connectivity-lawyers.trycloudflare.com/repair";
...
const DIRECT_LLM_REPAIR_ENDPOINT =
  process.env.NEXT_PUBLIC_DIRECT_LLM_REPAIR_ENDPOINT ?? "https://code-distribution-connectivity-lawyers.trycloudflare.com/repair";
